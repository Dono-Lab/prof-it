            ...
            <div class="card-custom mb-4">
                ...
                <div class="card-body-custom">
                    <div class="row">
                        ...
                        <?php else: ?>
                            <div class="col-12">
                                <p class="text-muted mb-0">Aucun dossier pour le moment.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <div class="card-body-custom">
                            <div class="documents-list" id="recent-documents">
                                <?php if (empty($documents)): ?>
                                    <p class="text-muted mb-0">Vous n'avez encore ajouté aucun document.</p>
                                <?php else: ?>
                                        ...
                                        <div class="document-card">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small class="text-muted"><?= $document['source'] === 'messaging' ? 'Envoyé via messagerie' : 'Ajouté manuellement' ?></small>
                                                </div>
                        ...
                        <div class="card-body-custom">
                            <form id="upload-form" enctype="multipart/form-data">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="document-category" name="categorie" placeholder="Ex : Ressources pédagogiques">
                                </div>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div>
                                ...
                                <div class="mt-3">
                                    ...
                                    ?>
                                        <p class="text-muted small mb-0">Aucune statistique disponible.</p>
                                    <?php else:
                ...
                <div class="document-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted">${doc.source === 'messaging' ? 'Envoyé via messagerie' : 'Ajouté manuellement'}</small>
                        </div>
                        <div class="document-actions">
