                                ...
                                <div class="document-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Partagé avec 12 étudiants</small>
                                        </div>
                                ...
                                <div class="document-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Partagé avec 8 étudiants</small>
                                        </div>
                                        <div class="document-actions">
                                            <button class="btn btn-sm btn-outline-primary me-1" onclick="downloadDocument(this)" title="Télécharger">
                                                <i class="fas fa-download"></i>
                                ...
                                <div class="document-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Partagé avec 15 étudiants</small>
                                        </div>
                                        <div class="document-actions">
                                            <button class="btn btn-sm btn-outline-primary me-1" onclick="downloadDocument(this)" title="Télécharger">
                                                <i class="fas fa-download"></i>
                                ...
                                <div class="document-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Partagé avec 10 étudiants</small>
                                        </div>
                                        <div class="document-actions">
                                            <button class="btn btn-sm btn-outline-primary me-1" onclick="downloadDocument(this)" title="Télécharger">
                                                <i class="fas fa-download"></i>
