                ...
                <div class="modal-body">
                    <div id="ticketDetailsContent">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control" id="ticketReplyMessage" rows="3" placeholder="Ajoutez des précisions ou répondez au support..."></textarea>
        ...
        async function openTicketDetails(ticketId) {
            ...
            try {
                ...
                if (messages.length === 0) {
                    ...
                    messagesContainer.innerHTML = messages.map(renderTicketMessage).join('');
                }
            } catch (error) {
