                                    ...
                                    <div id="current-avatar-display">
                                        <?php if (!empty($user['photo_url'])): ?>
                                            <img src="../<?= htmlspecialchars($user['photo_url'], ENT_QUOTES, 'UTF-8') ?>"
                                                alt="Avatar" class="rounded-circle border" width="80" height="80" style="object-fit: cover;">
                                        <?php else: ?>
                            ...
                            <div id="password-fields" style="display: none;">
                                <div class="alert alert-info py-2 mb-3">
                                    <small>
                                        ...
                                        <strong>Critères :</strong> Minimum 6 caractères
                                    </small>
                                </div>
            ...
            .then(data => {
                if (data.success) {
                    currentAvatarDisplay.innerHTML = `
                        <img src="${data.avatar_url}" alt="Avatar" class="rounded-circle border" width="80" height="80" style="object-fit: cover;">
                    `;
                    ...
                    if (!deleteBtn) {
                        ...
                        deleteButton.innerHTML = '<i class="fas fa-trash me-1"></i> Supprimer l\'avatar';
