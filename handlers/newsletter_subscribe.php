...
if (!$email) {
    header("Location: ../public/home.html?error=email_invalide");
    exit();
}
...
if ($stmt->execute([$email, $prenom, $token])) {
    header("Location: ../public/home.html?success=newsletter");
} else {
    header("Location: ../public/home.html?error=newsletter");
}
exit();
